...
<body>
    ...
    <?php
            ...
            <section>
                    ...
                    ?>
                            ...
                            <?php
                                    ...
                                    echo "<article>";
                                    echo "<h1 class=\"existencia\">Aún no hay promociones Activas.</h1>";
                                    echo "</article>";
                                    echo "</section>";
                                }
        ...
        <article>
            ...
            <section>
                ...
                <?php
                        ...
                        echo "<article>";
                        echo "<h1>No hay ofertas activas por el momento.</h1>";
                        echo "</article>";
                    }
                ...
                ?>
                        <article>
                            <h1>Esta empresa aún no tiene Promociones Disponibles</h1>
                        </article>
                <?php
                    }  
                ?>
        ...
        <?php
            ...
            echo "<article>"; 
            echo "<h1>Debe elejir una empresa válida</h1>";
            echo "</article>";
            echo "</section>";
        }
